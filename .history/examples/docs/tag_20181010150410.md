...
<div class="demo-block">
  ...
  <p></p>
  <p></p>
  <x-tag ishover>hover一</x-tag>
  <x-tag ishover color="success">hover二</x-tag>
  <x-tag ishover color="info">hover三</x-tag>
  <x-tag ishover color="warning">hover四</x-tag>
  <x-tag ishover color="danger">hover五</x-tag>
</div>
