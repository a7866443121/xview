...
<div class="demo-block">
  ...
  <x-tag color="danger">标签五</x-tag></br>
  <x-tag ishover>标签一</x-tag>
  <x-tag ishover color="success">标签二</x-tag>
  <x-tag ishover color="info">标签三</x-tag>
  <x-tag ishover color="warning">标签四</x-tag>
  <x-tag ishover color="danger">标签五</x-tag>
</div>
