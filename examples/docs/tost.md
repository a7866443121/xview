...
<script>
 export default {
    methods: {
      tost1() {
        this.$Tost({message: '吃饭没', type:'warn', times: 3000, icon:'icon-warning'});
      },
      tost2(){
        this.$Tost('没吃饭','success',3000,'icon-circle_ok');
      }
    }
  }
</script>
...
<div class="dome-alert demo-block">
  <x-button @click.native="tost1" type="primary">点击</x-button>
  <x-button @click.native="tost2" type="primary">点击</x-button>
</div>
